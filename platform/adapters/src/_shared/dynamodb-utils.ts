 ...
 *
 * @returns The core table name (e.g., "oncepass-core-dev")
 ...
 *
 * @returns The base table name (e.g., "oncepass-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "oncepass-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "oncepass-app-realtime-dev")

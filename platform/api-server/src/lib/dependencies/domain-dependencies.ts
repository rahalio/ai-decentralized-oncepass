...
export async function injectDomainDependencies(
  ...
  if (!domainDeps) {
    ...
    switch (domain) {
      case "access":
        domainDeps = buildAccessDomainModule(dynamoClient);
        break;
      case "consents":
      ...
      case "participants":
        ...
        break;
      case "vaults":
        domainDeps = buildVaultsDomainModule(dynamoClient);
        break;
      default:
        return;
    }
 ...
 */
export function getAccessDeps(
  request: FastifyRequest,
): DomainDependencies["access"] {
  return getDomainDeps(request, "access");
}
...
export function getVaultsDeps(
  request: FastifyRequest,
): DomainDependencies["vaults"] {
  return getDomainDeps(request, "vaults");
}
